...
const NotFoundPage = () => {
    ...
    return(
            ...
            <div className="text-center py-10">
                ...
                <span className="text-lg font-medium">Unfortunately the page you ARE looking for can't be found, probably because it doesn't exist... YET! In the meantime, why not check out our search page to see what else you can find.</span>
